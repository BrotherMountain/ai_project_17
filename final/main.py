...
class MainWindow(QMainWindow, mainUI.Ui_MainWindow):
    def __init__(self):
        ...
        self.bMask = False
        self.start_countdown1 = False
        self.alarm1_waiting = False
    ...
    def functionSaveAndRun(self):
        ...
        if self.mask_detect.isChecked():
            ...
            pass
            # threading.Timer(1, self.function1).cancel()
    ...
    def startTimer(self):
        ...
        self.count_minute_1 = self.minute_1
    ...
    def timerTimeout(self):
        if self.start_mask:
            self.alarm1()
            self.alarm1_waiting = True
        if self.start_countdown1 and self.alarm1_waiting:
            self.second_1 -= 1
            if self.second_1 == 0:
                self.second_1 = 60
                if self.count_minute_1 == 0:
                    self.mask_time.setText(str(self.minute_1) + ":" + str(self.second_1))
                    self.count_minute_1 = self.minute_1
                    self.alarm1_waiting = False
                    self.start_countdown1 = False
                else:
                    self.count_minute_1 -= 1
